# Sample bot that implements a basic "Big Money" style strategy.

## The field argument is a dict representing the current game state.
## You can access the following:
##      "hand": The player's hand, as a list.
##      "deck": deck
##      "discard": discard
##      "domain": domain
##      "points": points
